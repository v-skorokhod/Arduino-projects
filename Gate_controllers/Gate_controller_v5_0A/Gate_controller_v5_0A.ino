String filenameIDE = "Gate_contr._v5_0A"; // ИЗМЕНЯТЬ ПОСЛЕ ИЗМЕНЕНИЯ НАЗВАНИЯ ФАЙЛА !!! ####################################################################
...
byte button_pin[4] = {6,8,4,2}; // open, close, wicket, stop (менять пины местами для соответсвия пульта)
