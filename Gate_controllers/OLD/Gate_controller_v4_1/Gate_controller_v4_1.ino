...
void setup() {
  ...
  Serial.println("Gate_controller_v4_1");
  Serial.println("###########################");
  delay(100);
  ...
  left_gate.init(A4,3,8,A3,"LEFT"); // current_pin, forward_pin, reverse_pin, end_switch_pin (пины левой створки)
