...
int seeder_RPM_input_num = 0; // 0..2
#define MIN_POWER_RPMETER 30 // % 0..100
...
volatile unsigned long interrupt_period[3];//, interrupt_period_micros[3];
volatile unsigned long buffer_val_interrupt_period[3];
volatile unsigned long last_interrupt_period[3];//, last_interrupt_period_micros[3];
