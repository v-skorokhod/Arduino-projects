...
void control_func () {
  //Serial.println(toStr(local_interrupt_impulses[0]) + toStr(local_interrupt_impulses[1]) + toStr(local_interrupt_impulses[2]));//toStr(flow(herbicide_flow_input_num)) + toStr(volume(herbicide_flow_input_num)));
  //Serial.println("periods: " + String(interrupt_period[0]) + " | " + String(interrupt_period_micros[1]) + " | " + String(interrupt_period_micros[2]));
