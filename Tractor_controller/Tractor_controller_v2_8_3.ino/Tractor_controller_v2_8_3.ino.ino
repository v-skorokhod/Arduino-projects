...
String filenameIDE = "Tractor_controller_v2_8_3(28.05.24)"; // ИЗМЕНЯТЬ ПОСЛЕ ИЗМЕНЕНИЯ НАЗВАНИЯ ФАЙЛА !!!
String page_name;
// ########################################################### SETUP SETUP SETUP ################################################
void setup () {
  Serial.begin(57600);
  ...
  switch (MODULE_ID) {
    case 0: // main
      ...
      engine_temp = read_temp(engine_temp_ID);
      outside_temp = read_temp(outside_temp_ID);
      for (int i = 0; i < 7; i++) {
